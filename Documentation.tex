...
\item First solder the CDCLVC1104 chip on the base and glue it on the
  ...
  \begin{figure}[H]
    \centering \includegraphics[width=.3\textwidth]{support}\hfill
    \includegraphics[width=.3\textwidth]{base}\hfill
    \includegraphics[width=.3\textwidth]{base-glued}
...
\item Then take a 50 pins flat cable (that you are then going to
  ...
  \begin{figure}[H]
    \centering \includegraphics[width=0.7\linewidth]{J2}
    \caption{J2 connector pin-out}\label{J2}
  \end{figure}
\item Desolder the M9 chip
  \begin{figure}[H]
    \centering \includegraphics[width=0.5\linewidth]{desolder}
...
\item Referring to Figures~\ref{interface-connections}
  ...
  \begin{figure}[H]
    \centering
    \includegraphics[width=.3\textwidth]{interface-pinout1}\hfill
    \includegraphics[width=.3\textwidth]{interface-pinout2}\hfill
    \includegraphics[width=.3\textwidth]{ground}
...
\item The final result should look more or less like this:
  \begin{figure}[H]
    \centering \includegraphics[width=0.9\linewidth]{fixed-interface}
