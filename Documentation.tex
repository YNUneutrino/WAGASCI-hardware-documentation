...
\begin{figure}[ht]
  \centering \includegraphics[width=0.7\linewidth]{DAQ-schematics}
...
(Acquisition Networked Program for Accelerated Neutrinos). It is based on the
Calicoes software that was used for the Silicium Tungsten Electromagnetic
...
all the articles that I could find. These articles are also cited throughout the
